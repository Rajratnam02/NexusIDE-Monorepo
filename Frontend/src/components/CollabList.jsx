    ...
    <div className='grid  grid-cols-12 px-6 py-5 items-center hover:bg-[#161616] border border-t-0 border-gray-800/50 last:rounded-b-2xl cursor-pointer group'>
        <div className='col-span-6 flex items-center gap-3'>
            ...
            <div className='flex flex-col justify-center'>
              ...
              <p className='text-[10px] text-blue-500 font-bold uppercase tracking-tighter'>{data.lang}</p>
            </div>
        </div>
        ...
        <div className='col-span-2 text-right'>
            <p className={generalClass + (data.role === "editor" ? editorClass : viewerClass)}>{data.role}</p>
        </div>
