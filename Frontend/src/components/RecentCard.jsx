import { ChevronRight, Clock, Clock1, Edit3, GitBranch, GitFork, InfoIcon, PlayCircle, Plus, ShieldCheck, Trash2, UserPlus } from 'lucide-react'
...
const activityIcons = {
  ...
  const generalClass = "p-5 h-fit rounded-2xl absolute -translate-x-1/2 translate-y-1/2 border-2 shadow-xl transition-all duration-300";
  ...
  return (
    <div className='border-l w-full  flex relative  first:mt-10 border-blue-950 last:border-0 last:[&_.child]:block '>
        ...
        <div className='child hidden absolute  top-0 left-0 h-8  w-px bg-blue-950 border-blue-950 '>
        </div>
            ...
            <div className='flex flex-col md:flex-row md:items-center justify-between gap-2'>
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-gray-500 text-xs tracking-wide uppercase font-bold">{data.type}</span>
                    <span className="text-blue-400 font-mono text-sm hover:underline cursor-pointer">#{data.project}</span>
                  </div>
                ...
                <div className='flex items-center gap-4 text-right'>
                    <div className='flex flex-col items-end'>
                        <div className='flex items-center gap-1.5 text-gray-600'>
                            <Clock size={12} />
                            <p className="text-[10px] font-bold uppercase tracking-widest">{data.time}</p>
                        </div>
                    </div>
