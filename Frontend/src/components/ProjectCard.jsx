    ...
    <div className="group bg-[#111111] border  border-gray-800 rounded-2xl p-6 hover:border-blue-500/50 hover:bg-[#141414] transition-all cursor-pointer">
      <div className=" flex flex-col">
        ...
        <div className="flex items-center gap-2 mt-1">
          <p className="text-[10px] px-2 py-0.5 bg-blue-500/10 border border-blue-500/20 text-blue-400 rounded-md font-bold uppercase tracking-widest">
            {data.lang}
          </p>
        ...
        <div className="border-t border-gray-800 flex justify-between items-center mt-10">
          <div className="flex -space-x-2 pt-3">
            {data.collaborators.map((initials, index) => (
              <div
                key={index}
                className="h-7 aspect-square rounded-full bg-gray-800 border-2 border-[#111111] flex items-center justify-center text-[10px] font-bold text-gray-400 uppercase"
              >
                {initials}
              </div>
            ))}
