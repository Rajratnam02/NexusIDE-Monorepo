      ...
      <section className="max-w-7xl mx-auto px-8 pt-16 pb-24 text-center flex flex-col items-center justify-center ">
        <div className="flex flex-col items-center  max-w-4xl justify-center">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            The collaborative IDE built for speed. Pair program, debug, and ship
            code with your team in a powerful, sandboxed environment.
          </p>
        </div>
        ...
        <div className=" gap-10 flex">
          <p
            ...
            className="w-full cursor-pointer sm:w-auto px-8 py-4 bg-white text-black font-bold rounded-xl hover:bg-gray-200 transition-all flex items-center justify-center gap-2"
          >
            <Users size={20} />
            Join a Room
          </p>
          <p
            ...
            className="w-full cursor-pointer sm:w-auto px-8 py-4 bg-[#1E2939] text-white font-bold rounded-xl hover:bg-[#28374d] transition-all flex items-center justify-center gap-2"
          >
            Create New Project
          </p>
        </div>
          ...
          <div className="bg-[#1E1E1E] border border-gray-800 border-t-0 rounded-b-xl h-50">
            <div className="flex flex-col px-10 py-5">
              ...
              <p className="text-gray-400 mt-2">
                ...
                <span className="text-yellow-300">collaborate</span>(team):
              </p>
